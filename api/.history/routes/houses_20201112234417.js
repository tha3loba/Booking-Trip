...
//add houses router
router.POST("/ADDHouse", userAuth, async(req, res) => {
    return await AddHouses(req, res);
});

//delete houses router
router.delete("/DelHouse", userAuth, async(req, res) => {
    return await DELETEHouses(req, res);
});

//Update house router 
router.put("/UPDATEHouse", userAuth, async(req, res) => {
...
//add Rooms router
router.POST("/ADDRoom", userAuth, async(req, res) => {
